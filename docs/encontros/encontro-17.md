# Encontro 17 — Tool calling: contratos, execução segura e permissões

## Organização

- Unidade pedagógica: 1;
- duração: 90 minutos (2 aulas de 45 minutos);
- tema curricular: Tool calling: contratos, execução segura e permissões.

## Objetivos

- Descrever ferramentas e validar argumentos.
- Manter autorização, execução e erros sob controle do backend.

## Desenvolvimento sugerido

1. retomada e questão-problema — 10 min;
2. fundamentação e demonstração — 40 min;
3. implementação de dispatcher com allowlist — 30 min;
4. síntese e registro — 10 min.

## Resultado esperado

Tool calling controlado e testado.
