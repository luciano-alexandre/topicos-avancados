# Encontro 11 — Engenharia de prompts: estrutura, estratégias e templates
...
| fallback semântico | tratar ausência de evidência | retornar `OUTROS` |
...
versionamento; esse assunto será aprofundado no Encontro 12.
...
No Encontro 13, essa saída passará a usar schema e validação estruturada. Por
